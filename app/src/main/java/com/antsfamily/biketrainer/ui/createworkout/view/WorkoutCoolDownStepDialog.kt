...
import com.antsfamily.biketrainer.presentation.createworkout.WorkoutCoolDownStepDialogViewModel
...
@Composable
fun WorkoutCoolDownStepDialog(
    step: WorkoutStep.CoolDown? = null,
    onDismiss: () -> Unit,
    onConfirmClick: (WorkoutStep.CoolDown) -> Unit,
    viewModel: WorkoutCoolDownStepDialogViewModel = hiltViewModel()
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = step?.let { "Update existed Cool-Down stage" } ?: "Add a Cool-Down stage",
            ...
            Column(
                ...
                DurationView(state.value.duration) {
